...
export class FiguraGeometricaComponent implements OnInit {
  ...
  todo = [
    {
      imagen: 'assets/Img/cuadrado-azul.png',
      name: 'cuadrado-azul',
      answer: 'correcta',
    },
    {
      imagen: 'assets/Img/cuadrado-verde.png',
      name: 'cuadrado-verde',
      answer: 'error',
    },
    {
      imagen: 'assets/Img/cuadrado-rojo.png',
      name: 'cuadrado-rojo',
      answer: 'correcta',
    },
    {
      imagen: 'assets/Img/rectangulo-rojo.png',
      name: 'rectangulo-rojo',
      answer: 'error',
    },
    {
      imagen: 'assets/Img/rectangulo-azul.png',
      name: 'rectangulo-azul',
      answer: 'error',
    },
    {
      imagen: 'assets/Img/rectangulo-verde.png',
      name: 'rectangulo-verde',
      answer: 'error',
    },
    {
      imagen: 'assets/Img/triangulo-rojo.png',
      name: 'triangulo-rojo',
      answer: 'error',
    },
    {
      imagen: 'assets/Img/triangulo-verde.png',
      name: 'triangulo-verde',
      answer: 'correcta',
    },
    {
      imagen: 'assets/Img/triangulo-azul.png',
      name: 'triangulo-azul',
      answer: 'error',
    },
  ];
  ...
  ngOnInit(): void {
    ...
    this.nivel2 = [
      ...
      {
        imagen: 'assets/Img/circulo-azul.png',
        name: 'circulo-azul',
        answer: 'error',
      },
      {
        imagen: 'assets/Img/circulo-verde.png',
        name: 'circulo-verde',
        answer: 'correcta',
      },
      {
        imagen: 'assets/Img/circulo-rojo.png',
        name: 'circulo-rojo',
        answer: 'error',
      },
    ];
    ...
    this.nivel3 = [
      ...
      {
        imagen: 'assets/Img/rombo-rojo.png',
        name: 'rombo-rojo',
        answer: 'correcta',
      },
      {
        imagen: 'assets/Img/rombo-azul.png',
        name: 'rombo-azul',
        answer: 'error',
      },
      {
        imagen: 'assets/Img/rombo-verde.png',
        name: 'rombo-verde',
        answer: 'error',
      },
    ];

    this.todo.sort(function () {
  ...
  drop(event: CdkDragDrop<string[]>) {
    if (event.previousContainer === event.container) {
      ...
      if (
        ...
        this.done[2].name === 'cuadrado-azul'
      ) {
        var figuras = document.getElementById('figuras');
        ...
        this.done[2].name === 'triangulo-azul' &&
        ...
        this.done[1].name === 'rectangulo-azul' &&
        this.done[2].name === 'rombo-rojo' &&
        this.done[3].name === 'circulo-azul' &&
        this.done[4].name === 'triangulo-verde'
      ) {
        var figuras = document.getElementById('figuras');
        figuras.style.opacity = '0.3';
        figuras.style.pointerEvents = 'none';
