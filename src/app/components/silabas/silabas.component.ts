...
export class SilabasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.nivel3 = [
      ...
      {imagen:'assets/Img/hipopotamo_2.png', silabas:5, name: "hipopotamo_2"}
    ];
    ...
    this.nivel4.sort(function() {return Math.random() - 0.5});
    this.nivel5.sort(function() {return Math.random() - 0.5});
    this.nivel6.sort(function() {return Math.random() - 0.5});
